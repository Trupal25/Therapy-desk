      ...
      {mobileMenuOpen && (
        <div className="mobile-menu-overlay">
          ...
          <div className="mobile-menu-panel">
            ...
            <a href="/app" className="mobile-menu-link" onClick={() => setMobileMenuOpen(false)}>App Workspace</a>
            <a href="/contact" className="mobile-menu-link active" onClick={() => setMobileMenuOpen(false)}>Contact</a>
            <a href="/admin" className="mobile-menu-link" onClick={() => setMobileMenuOpen(false)}>Admin</a>
          </div>
        </div>
      )}
